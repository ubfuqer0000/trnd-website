    ...
    <footer className="pt-20 pb-10 px-6 md:px-16 bg-brand-dark border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className={`grid grid-cols-1 ${isContactPage ? 'md:grid-cols-3' : 'md:grid-cols-4'} gap-12 mb-16`}>
          ...
          {/* 3. Contact Details - سيختفي في صفحة التواصل */}
          {!isContactPage && (
